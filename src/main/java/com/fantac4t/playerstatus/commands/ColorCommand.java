    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register(Commands.literal("color")
            ...
            .then(Commands.literal("gradient")
                .then(Commands.argument("hex1", StringArgumentType.word())
                    .then(Commands.argument("hex2", StringArgumentType.word())
                        .executes(ctx -> {
                            var player = ctx.getSource().getPlayerOrException();
                            String hex1 = RGBColorProcessor.normalizeColorInput(StringArgumentType.getString(ctx, "hex1"));
                            String hex2 = RGBColorProcessor.normalizeColorInput(StringArgumentType.getString(ctx, "hex2"));
