...
public final class RolePlaceholder {
    ...
    private static final Identifier ROLE_ID    = Identifier.fromNamespaceAndPath(FSP.PLACEHOLDER_NS, "role");
    private static final Identifier NAMETAG_ID = Identifier.fromNamespaceAndPath(FSP.PLACEHOLDER_NS, "suffix");
    ...
    private static PlaceholderResult roleResult(PlaceholderContext ctx) {
        ...
        String symbol = FSP.CONFIG.roles.groups.getOrDefault(group, "");
    ...
    private static String resolveGroup(UUID id) {
        ...
        try {
            ...
            FSP.LOGGER.warn("Failed to resolve LuckPerms group for {}: {}", id, e.getMessage());
            return "";
        }
    }
}
